...
SHELL=bash
FILES=rofi-hamster hamster-monitor.sh
IMG_VERSION=0.2
...
docker:  ## Build and push docker CI image
	docker build -t registry.gitlab.com/matclab/rofi-hamster/rh-test:${IMG_VERSION} docker \
	&& docker push registry.gitlab.com/matclab/rofi-hamster/rh-test:${IMG_VERSION}
